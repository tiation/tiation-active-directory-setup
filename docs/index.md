---
layout: default
title: Tiation Active Directory Setup - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Active Directory Setup</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-active-directory-setup" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-active-directory-setup .

# Run container
docker run -p 8080:8080 tiation-active-directory-setup
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-active-directory-setup)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-active-directory-setup/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-active-directory-setup/discussions)
